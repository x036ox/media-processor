...
public class MinioServiceImpl implements MinioService{
    ...
    @Override
    public File download(String objectName) throws Exception {
        File file;
        minioClient.downloadObject(DownloadObjectArgs.builder().bucket(minioConfig.getStoreBucket()).object(objectName).overwrite(true).filename("index.mp4").build());
        file = new File("index.mp4");
        return file;
    }
